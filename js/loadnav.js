function loadNav() {
	const navbarcont = `<header class="headerbar">
	  ...
	  <ul class="links">
	    <li><a href="reflections.html"><span class="fa fa-book"></span>&nbsp;Reflections/Journal Entries</a></li>
	    <li><a href="index.html"><span class="fa fa-home"></span>&nbsp;Home</a></li>
	  </ul>
	</header>
	`;
	
	const footercont = `<footer style='position: fixed;height: 20px;background: #6067ba;color: white;bottom: 0;left: 0;right: 0px;width: 100%;margin-bottom: 0px;clear: both;text-align: center;padding: 15px;'>(c) 2024 Reymundo Esteves II</footer>`;
